...
func (c *PluginConnection) Update(report PluginReport) error {
	if (report.OnlinePlayers != nil && (*report.OnlinePlayers < 0 ||
		(report.MaxPlayers != nil && *report.OnlinePlayers > *report.MaxPlayers))) ||
		(report.MaxPlayers != nil && *report.MaxPlayers < 0) ||
